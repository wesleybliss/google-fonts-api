...
export default function Home() {
    return (
        <div
            className={`${uiFont.variable} ${displayFont.variable} min-h-screen bg-[radial-gradient(circle_at_top,_#fff5e6_0,_#f7f4ff_38%,_#eef2ff_68%,_#f9fafb_100%)] text-slate-900`}
